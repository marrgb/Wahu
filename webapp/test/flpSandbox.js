		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "wahu",
									"targetURL": "#comordagowahu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comordagowahu-display": {
								"semanticObject": "comordagowahu",
								"action": "display",
								"description": "Administrador de Propiedades",
								"title": "wahu",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ordago.wahu",
									"url": sap.ui.require.toUrl("com/ordago/wahu")
								}
							}
						}
					}
